...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out freeme artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <freeme', 'Foo bar '],
      ['Foo bar <freemea', 'Foo bar <freemea'],
      ['Foo bar <freemeA', 'Foo bar '],
      ['Foo bar <freemeArtifacs></freemeArtifact>', 'Foo bar <freemeArtifacs></freemeArtifact>'],
      ['Before <oltArtfiact>foo</freemeArtifact> After', 'Before <oltArtfiact>foo</freemeArtifact> After'],
      ['Before <freemeArtifactt>foo</freemeArtifact> After', 'Before <freemeArtifactt>foo</freemeArtifact> After'],
    ])('should correctly parse chunks and strip out freeme artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <freemeArtifact title="Some title" id="artifact_1">foo bar</freemeArtifact> Some more text',
        {
      ...
      [
        ['Some text before <freemeArti', 'fact', ' title="Some title" id="artifact_1">foo</freemeArtifact> Some more text'],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
      ...
      [
        [
          'Some text before <freemeArti',
          'fac',
          't title="Some title" id="artifact_1"',
          ' ',
          '>',
          'foo</freemeArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</freemeArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <freemeArtifact title="Some title" id="artifact_1">foo</freemeArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <freemeArtifact title="Some title" id="artifact_1"><freemeAction type="shell">npm install</freemeAction></freemeArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <freemeArtifact title="Some title" id="artifact_1"><freemeAction type="shell">npm install</freemeAction><freemeAction type="file" filePath="index.js">some content</freemeAction></freemeArtifact> After',
        {
          output: 'Before  After',
